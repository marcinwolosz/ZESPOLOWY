...
import com.example.baidMarcinos.kolkoikrzyzyk.ItemClickSupport;
import com.example.baidMarcinos.kolkoikrzyzyk.R;
import com.example.baidMarcinos.kolkoikrzyzyk.activities.GameRoomActivity;
import com.example.baidMarcinos.kolkoikrzyzyk.adapters.UsersListRecyclerAdapter;
import com.example.baidMarcinos.kolkoikrzyzyk.getUsers.GetUsersContract;
import com.example.baidMarcinos.kolkoikrzyzyk.getUsers.GetUsersPresenter;
...
public class UsersFragment extends Fragment implements GetUsersContract.View, ItemClickSupport.OnItemClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private UsersListRecyclerAdapter mUserListingRecyclerAdapter;
...
//    @Override
    ...
    public void onItemClicked(RecyclerView recyclerView, int position, View v) {
        GameRoomActivity.startActivity(getActivity(),
...
//    @Override
    public void onGetAllUsersSuccess(List<User> users) {
        ...
        mUserListingRecyclerAdapter = new UsersListRecyclerAdapter(users);
